...
$sqlS = "SELECT * FROM addstudent_tb where addmission='" . $_SESSION['addmission'] . "'";
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">Fees details</h2>
                </div>
                                        ...
                                        <div id="" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                            <div class="row">
                                                <div class="col-sm-12" style="overflow-x: auto;">
                                                    <?php
                                                    include 'db_connect.php';
                                                    $sql = "SELECT * FROM addfees where name='$name'";
