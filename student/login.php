                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header no-border">
                                <div class="card-title text-xs-center">
                                    <div class="p-1"><img src="../images/logohostel-blue.png" height="100" width="300"></div>
                                </div>
                            </div>
                                ...
                                <div class="card-block">
                                    <form class="form-horizontal form-simple" action="loginadmin.php" method="post">
                                        <fieldset class="form-group position-relative has-icon-left mb-1">
                                            <input type="text" class="form-control form-control-lg input-lg" id="user-name" name="addmission" placeholder="Addmission Number" required>
